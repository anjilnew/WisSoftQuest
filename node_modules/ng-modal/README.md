...
This module is based on [ngx-modal](https://github.com/pleerock/ngx-modal) which is no longer maintained
...
2. If you are using system.js you may want to add this into `map` and `package` config:
    ...
    {
        "map": {
            "ng-modal": "node_modules/ng-modal"
        },
        "packages": {
            "ng-modal": { "main": "index.js", "defaultExtension": "js" }
        }
    }
    ```
